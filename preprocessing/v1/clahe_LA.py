"""
preprocessing/v1/clahe_LA.py

V1 Preprocessor: CLAHE on L and A channels of LAB colour space.

Algorithm:
    1. RGB → LAB  (cv2.COLOR_RGB2LAB)
    2. Split into L, A, B channels
    3. Apply CLAHE to L and A channels  (B untouched)
...
class V1LAPreprocessor:
    """CLAHE on L and A channels.
    ...
    def apply(self, image: np.ndarray, label: np.ndarray = None):
        """Apply CLAHE to L and A channels.
        ...
        lab_clahe = cv2.merge((l_clahe, a_clahe, b))
