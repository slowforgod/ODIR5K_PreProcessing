"""
preprocessing/v1/clahe_LAB.py

V1 Preprocessor: CLAHE on L, A, and B channels of LAB colour space.

Algorithm:
    1. RGB → LAB  (cv2.COLOR_RGB2LAB)
    2. Split into L, A, B channels
    3. Apply CLAHE to all three channels
...
Parameters (from configs_ResNet/v1_LAB.yaml):
...
class V1LABPreprocessor:
    """CLAHE on L, A, and B channels.
    ...
    def apply(self, image: np.ndarray, label: np.ndarray = None):
        """Apply CLAHE to L, A, and B channels.
