...
Usage:
    python -m train_ResNet.train_v7 --config configs_ResNet/v7_efficientnet.yaml
    python -m train_ResNet.train_v7 --config configs_ResNet/v7_efficientnet.yaml --smoke
"""
